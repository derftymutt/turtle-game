extends FlipperBase
class_name CloudFlipperRightUp

## Cloud Flipper - Right Side, Upward Launch
## Identical angles to FlipperRightUp, with layer-based pass-through
...
@export var pass_through_velocity_threshold: float = -200.0
